	...
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				<p class="text1"><span id="text-75" contenteditable="true">呆呆大鹏</span> ❤ <span id="text-76" contenteditable="true">酷酷小朱</span> <span id="text-77" contenteditable="true">三周年</span></p>
				<p class="text2">按键盘 "↓" <span id="text-78" contenteditable="true">开始</span></p>
			</div>
			<div id="/section-1/page-2" class="ft-page page-2" data-id="page-2">
				<p class="top-text" id="text-1" contenteditable="true">一起参加实验室的掼蛋比赛，心有灵犀的我们一路过关斩将，最后拿了三等奖，这是我第一次约你。</p>
				<img src='img/iali63.jpg'  alt="一起参加实验室的掼蛋比赛，心有灵犀的我们一路过关斩将，最后拿了三等奖，这是我第一次约你。" />
			</div>
			<div id="/section-1/page-3" class="ft-page page-3 left-img" data-id="page-3">
				<img src='img/iali35.jpg' />
				<h3>
					<span id="text-2_1" contenteditable="true">我们一起去广州玩，</span><br />
					<span id="text-2_2" contenteditable="true">这是我们第一次出去旅游，</span><br />
					<span id="text-2_3" contenteditable="true">我有许多地方没做好，</span><br />
					<span id="text-2_4" contenteditable="true">但每次回忆起来，</span><br />
					<span id="text-2_5" contenteditable="true">都感觉很开心和幸福。</span><br />
				</h3>
			</div>
			<div id="/section-1/page-4" class="ft-page page-4 right-img" data-id="page-4">
				<!-- <h2 class="left-text" id="text-3" contenteditable="true">每次你喝奶茶都要喝我们两个人的，我的第一口要留给你，可可爱，我经常会忘记，我该打。</h2> -->
				<img src='img/iali6.jpg' />
				<h3>
					<span id="text-3_1" contenteditable="false">每次你喝奶茶都要喝我们两个人的，</span><br />
					<span id="text-3_2" contenteditable="false">我的第一口要留给你，你可可爱，</span><br >
					<span id="text-3_3" contenteditable="false">我经常会忘记，我该打。</span><br />
				</h3>
			</div>
		</div>
		<div class="ft-section section-2" data-id="section-2">
			<div id="/section-2/page-1" class="ft-page page-5 left-img" data-id="page-1">

				<!-- <h2 class="right-text" id="text-4" contenteditable="true">一起去爬早就想爬的操场栏杆，已经过去了两年多，但当时的场景还历历在目，每次翻相册看到这张照片都觉得可好玩，你能给我带来各种各样的乐趣。</h2> -->
				<img src='img/iali19.jpg' />
				<h3>
					<span id="text-4_1" contenteditable="true">一起去爬早就想爬的操场栏杆，</span><br />
					<span id="text-4_2" contenteditable="true">已经过去了两年多，</span><br >
					<span id="text-4_3" contenteditable="true">但当时的场景还历历在目，</span><br >
					<span id="text-4_4" contenteditable="true">每次看到这张照片都觉得可好玩，</span><br />
					<span id="text-4_5" contenteditable="true">你能给我带来各种各样的乐趣。</span><br />
				</h3>
			</div>
